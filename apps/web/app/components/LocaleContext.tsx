...
// This file was moved into the app/components directory so that it can be
// resolved by Next.js during the build. It exports the same locale context
// utilities that were previously located in ../../components/LocaleContext.tsx.
// The contents are copied directly from the original file to preserve
// functionality.
